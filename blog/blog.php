...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0" action="filter.html">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit" action='filter.html'>Filter Posts</button>
                </form>
            </div>
        </nav>
